...
const simplifyAST = require('./simplifyAST');

const { Model } = require('sequelize');
const { replaceWhereOperators } = require('./replaceWhereOperators.js');
...
module.exports = {
  ...
  isConnection,
  handleConnection,
  sequelizeNodeInterface: createNodeInterface,
  nodeType,
  createConnectionResolver,
  sequelizeConnection: createConnection
};
